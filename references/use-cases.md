...
| 纳维里尔八大指标筛选 | `run_screener.py --preset navellier` | 纳维里尔《怎样选择成长股：持续获利选股8大指标》标准（盈利/营收双高增+高ROE+现金流+利润率趋势+机构预测增速+盈利动能，非收益预测）；盈利预期上调用机构一致预测代理（有乐观偏差，上调方向须人工核查研报），盈利惊喜仅港美股有数据（--earnings-surprise 叠加），建议接 canslim 验证盈利加速真实性 + scan 趋势/RS 复核 + portfolio 组合持有 | [scoring.md](scoring.md) |
